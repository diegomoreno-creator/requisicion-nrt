-- Update the can_view_requisicion function to allow autorizadores to see requisitions they have authorized
...
BEGIN
  ...
  SELECT solicitado_por, autorizador_id, autorizado_por, estado, deleted_at 
  INTO req_solicitante, req_autorizador, req_autorizado_por, req_estado, req_deleted_at 
