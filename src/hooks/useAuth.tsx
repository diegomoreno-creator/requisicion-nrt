...
export type AppRole = 'superadmin' | 'admin' | 'comprador' | 'solicitador' | 'autorizador' | 'presupuestos' | 'tesoreria' | 'inactivo' | 'contabilidad1' | 'contabilidad_gastos' | 'contabilidad_ingresos' | 'revision' | 'almacen';
